...
const Blog = () => {
  ...
  const articles = [
    ...
    },
    {
      ...
      excerpt: "Guide complet pour préparer votre animal à accueillir un pet sitter et assurer une expérience positive pour tous.",
      content: "La première expérience de garde à domicile peut être stressante tant pour vous que pour votre chien. Une préparation adéquate est la clé d'une expérience réussie qui bénéficiera à tous les participants.\n\nCommencez par habituer progressivement votre chien à la présence d'étrangers dans votre domicile. Invitez le pet sitter pour une ou plusieurs visites de familiarisation avant la garde proprement dite. Ces rencontres permettront à votre animal de s'habituer à la nouvelle personne et de créer un lien de confiance.\n\nPréparez un dossier détaillé contenant toutes les informations importantes : habitudes alimentaires, horaires de promenade, médicaments éventuels, coordonnées du vétérinaire, et numéros d'urgence. Plus le pet sitter sera informé, mieux il pourra s'occuper de votre compagnon.\n\nLaissez des objets familiers comme son jouet préféré ou une couverture avec votre odeur. Ces éléments rassurants aideront votre chien à mieux gérer votre absence et à se sentir en sécurité avec le pet sitter.",
